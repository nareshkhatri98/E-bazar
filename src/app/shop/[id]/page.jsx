          ...
          <div className=" w-[647px] h-[88px] flex items-center">
            <div className="w-[124px] h-[50px] -400 border-[1px] rounded-[170px] p-[8px] ">
              <div className="text-4xl flex items-center justify-between ">
                <button onClick={()=>dispatch(decreaseItemQuantity(product.id))} className="bg-Gray-0.5 border rounded-full w-[34px] h-[34px] text-center  p-1 font-600">
                  -
                </button>
                ...
                <button onClick={()=>dispatch(increaseItemQuantity(product.id))} className="bg-Gray-0.5 border rounded-full w-[34px] h-[34px] text-center  p-1 font-600">
                  +
                </button>
              </div>
            </div>
            <div className="bg-primary w-[447px] h-[51px] rounded-[43px] p-[10px] m-[12px] flex items-center justify-center gap-4">
              <button onClick={()=>dispatch(addToCart(product))} className="text-center text-white">Add to Cart</button>
              <Image
                src={rectangleIcon}
