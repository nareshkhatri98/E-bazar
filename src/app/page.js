    ...
    <main>
      ...
      <section className="container mx-auto bg-[#EDF2EE] w-[95rem] h-[804px] mt-6 rounded-[8px] relative ">
        ...
        <Image
          src={containerIcon}
          alt="container icon"
          className="  absolute top-[48.9rem] right-96 left-[750px]"
        />
      </section>
      {/* services section */}
      ...
      products.map((product, index) => (
        <div key={index} className="w-[248px] border relative">
          ...
          <div className="mt-3 ml-4">
            <p className="font-normal font-[Poppins] text-[0.875rem] leading-[1.3125rem]">{product.title}</p>
            <p className="text-[1rem] font-medium text-[#1A1A1A] leading-[1.5rem]">{product.price}</p>
            <Image src={ratingIcon} alt="rating icon" className="mb-4 mt-[6px]" />
          </div>
          <div className="absolute bottom-[1rem] left-[11rem] w-10 h-10 bg-[#f2f2f2] rounded-full flex items-center justify-center">
